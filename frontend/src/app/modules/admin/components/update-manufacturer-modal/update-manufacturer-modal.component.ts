...
export class UpdateManufacturerModalComponent implements OnInit {
  form = new FormGroup({
  ...
  updateItem() {
    this.store$.dispatch(updateManufacturer({ dto: this.form.getRawValue(), id: this.data.manufacturer.id }))
